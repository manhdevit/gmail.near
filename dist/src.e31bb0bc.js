...
var CONTRACT_NAME = "dev-1630505259962-8480777" || 'near';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("C:\\Users\\ADMIN", "/.near/validator_key.json"),
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return new _nearApiJs.Contract(window.walletConnection.account(), nearConfig.contractName, {
              ...
              viewMethods: ['getGreeting', 'getHello', 'getVote1', 'getVote2', 'ge'],
              // Change methods can modify the state. But you don't receive the returned value when called.
              changeMethods: ['setGreeting', 'Vote1', 'Vote2']
            });
